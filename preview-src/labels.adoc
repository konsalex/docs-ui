...
label[{type: "aura"}Neo4j Aura]
label:primary[Neo4j]
label:success[This is a label]
label:warning[Enterprise Edition]
label:danger[Enterprise Edition]

// Log Warning that this label should not be used
label:non-success[Enterprise Edition]

`aura-label` -> label:success
`apoc-full` -> label:success
